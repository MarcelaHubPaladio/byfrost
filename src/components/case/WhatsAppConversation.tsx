...
export function WhatsAppConversation({ caseId }: { caseId: string }) {
  ...
  return (
    <div className="rounded-[22px] border border-slate-200 bg-[hsl(var(--byfrost-bg))] shadow-sm overflow-hidden">
      {/* Header */}
      ...
      {tab === "participants" ? (
        <div className="bg-white p-4">
          ...
          <div className="mt-2 grid gap-2">
            {participants.map((p) => (
              <div key={p} className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2">
                <div className="min-w-0">
        ...
        <div className="grid grid-rows-[1fr_auto]">
          ...
          <div
            ref={scrollerRef}
            className="h-[420px] overflow-y-auto px-3 py-4 sm:px-4"
          >
            {waMsgsQ.isError && (
                      ...
                      >
                        {m.type === "image" && m.media_url ? (
                          ...
                          <div className="space-y-2">
                            <div className={cn("text-sm font-medium", inbound ? "text-slate-900" : "text-white")}>Áudio</div>
                            {m.media_url ? (
                          ...
                          <div className="space-y-1">
                            <div className={cn("flex items-center gap-2 text-sm font-medium", inbound ? "text-slate-900" : "text-white")}>
